                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table">
                                        ...
                                        foreach (App::getDB()->query('SELECT DISTINCT id_services, id_module_admin, module_admin.libelle, module_admin.description, estimation, unites FROM module_outils, module_admin, outils_technique, services
                                                                                ...
                                                                                AND outils_technique.ref_id_services=services.id_services AND services.id_services=2
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-sm-6">
                                        ...
                                        <div class="dataTables_length" id="dataTables-example_length">
                                            ...
                                            <label for="list_cat_mod_cli">Affichage :
                                                ...
                                                <select id="list_cat_mod_cli" name="list_cat_mod_cli" aria-controls="dataTables-example" class="form-control input-sm" style="background-color: #fff;color: #555;">
