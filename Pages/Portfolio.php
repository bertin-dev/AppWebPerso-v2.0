    ...
    <div class="container">
        <div class="row">
         ...
         WHERE statut="1" AND id_page=' . $_ENV['id_page']) as $portfolio):
                    ...
                    <div class="col-lg-12 well" style="background: url('img/pattern15.png');">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#<?= 'freelance' . $portfolio->id_contenu; ?>"
                                                  title="<?= $portfolio->type_service; ?>" data-toggle="tab"><i
                                            class="icon-briefcase"></i><?= $portfolio->type_service; ?></a></li>
                            <li><a href="#<?= 'travaux' . $portfolio->id_contenu; ?>" title="Travaux" data-toggle="tab">TRAVAUX</a>
                            </li>
                            <li><a href="#<?= 'captures' . $portfolio->id_contenu; ?>" title="Captures"
                                   data-toggle="tab">CAPTURES</a></li>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="<?= 'freelance' . $portfolio->id_contenu; ?>">
                                <div class="col-lg-6">
                                    ...
                                    <strong>Type de Service:</strong> <em>
                                        <small><?= $portfolio->type_service; ?></small>
                                    </em><br>
                                    <strong>Entite:</strong> <em>
                                        <small><?= $portfolio->entite; ?></small>
                                    </em><br>

                                </div>
                                <div class="col-lg-6">
                                    <strong>Nom d'Entité:</strong> <em>
                                        <small><?= $portfolio->nom_entite; ?></small>
                                    </em><br>
                                    <strong>Activité:</strong> <em>
                                        <small><?= $portfolio->activite; ?></small>
                                    </em><br>
