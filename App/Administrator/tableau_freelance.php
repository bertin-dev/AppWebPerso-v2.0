...
<body>
    ...
    <div id="wrapper">
        ...
        <?php
        if(isset($_GET['modifFreelance'])){
            foreach (App::getDB()->query('SELECT * FROM body WHERE id_body='.$_GET['modifFreelance']) AS $ccompte):
                ?>
                <article class="col-lg-offset-3">
                    <h1>MODIFICATION DES PROJETS FREELANCE</h1>
                    <form id="modif_compte" method="post" accept-charset="UTF-8" action="traitement.php" enctype="multipart/form-data">
                        <input type="hidden" name="id_bodyFreelance" value="<?=$ccompte->id_body;?>">
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input id="entiteentite" type="text" name="entite" placeholder="ENTITE" class="form-control" value="<?=utf8_encode($ccompte->entite);?>">
                            </div>
                        </div>
                        <div class="form-group">
                           <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <label for="nom_entite">NOM_ENTITE</label>
                                <input id="nom_entite" type="text" name="nom_entite" class="form-control" placeholder="NOM_ENTITE" value="<?=utf8_encode($ccompte->nom_entite);?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-lg-6">
        ...
        <?php
            ...
            if(isset($_GET['suppFreelance'])){
                App::getDB()->delete('DELETE FROM body WHERE id_body=:id', ['id' =>$_GET['suppFreelance']]);
            }
            ?>
                    <div class="col-lg-12">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <th width="1%">ID</th>
                                            <th width="5%">ANNEE</th>
                                            <th width="5%">ENTITE</th>
                                            <th width="5%">ACTIVITE</th>
                                            <th width="5%">NOM_ENTITE</th>
                                            <th width="5%">VILLE</th>
                                        ...
                                        foreach (App::getDB()->query('SELECT * FROM body
                                            ...
                                            echo '<tr>
                                                        ...
                                                        <td title="ENTITE">'.$body->entite.'</td> 
                                                        <td title="ACTIVITE">'.$body->activite.'</td> 
                                                        <td title="NOM_ENTITE">'.$body->nom_entite.'</td> 
                                                ...
                                                for($i=0;$i<count($img)-1;$i++)
                                                 echo '<br><img src="../Public/'.$img[$i].'" class="img-responsive" title="" alt=""/>';
                                                     ...
                                                     echo '</td> 
                                                        ...
                                                        <td title="MODIFIER"><a href="tableau_freelance.php?modifFreelance='.$body->id_body.'">MODIFIER</a></td>
                                                        <td title="SUPPRIMER"><a href="tableau_freelance.php?suppFreelance='.$body->id_body.'">SUPPRIMER</a></td>
                                                   </tr>';
                                        endforeach;
                                        ?>
                                        </tbody>
